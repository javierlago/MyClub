...
public class CreateUserActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public boolean setUser() {
        ...
        if(userRol.equalsIgnoreCase(getResources().getString(R.string.directivo))){
            ...
            return userName.getText().toString().isEmpty() || firstSurname.getText().toString().isEmpty() || secondSurname.getText().toString().isEmpty() || phoneNumber.getText().toString().isEmpty() || email.getText().toString().isEmpty() || weight.getText().toString().isEmpty() || height.getText().toString().isEmpty() || dayOfBirth.getText().toString().isEmpty() || password.getText().toString().isEmpty();
        }else{
            return false;
        }
    }
    public void hideFields(String userRolApi){
        if(userRolApi.equalsIgnoreCase(getResources().getString(R.string.directivo))){
            ...
            if(userRol.equalsIgnoreCase(Constantes.getDirectivo(this))){
                txtWeight.setVisibility(View.GONE);
                weight.setVisibility(View.GONE);
                txtHeight.setVisibility(View.GONE);
                height.setVisibility(View.GONE);
    ...
    public void onClick(View v) {
        if (v == checkBox_show_passwor) {
            ...
            if (setUser()) {
                dialogWindows.warningWindows(CreateUserActivity.this, getResources().getString(R.string.create_user_warning_title), getResources().getString(R.string.create_user_warning_message));
            }else if(!Validations.isValidEmail(email.getText().toString())){
                dialogWindows.warningWindows(CreateUserActivity.this, getResources().getString(R.string.create_user_warning_title), getResources().getString(R.string.create_user_warning_message_email));
            } else if(!Validations.isValidPassword(password.getText().toString())){
                dialogWindows.warningWindows(CreateUserActivity.this, getResources().getString(R.string.create_user_warning_title), getResources().getString(R.string.create_user_warning_message_password));
            } else {
           ...
           if(userRol.equalsIgnoreCase(Constantes.getDirectivo(this))){
               intent = new Intent(CreateUserActivity.this, DirectivoActivity.class);
               startActivity(intent);
           } else if (userRol.equalsIgnoreCase(Constantes.getEntrenador(this))) {
               intent = new Intent(CreateUserActivity.this, EntrenadorActivity.class);
           } else if (userRol.equalsIgnoreCase(Constantes.getAtleta(this))) {
                intent = new Intent(CreateUserActivity.this, AtletaActivity.class);
           }
